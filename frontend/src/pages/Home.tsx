              ...
              <ScrollReveal key={cat.name} delay={idx * 150}>
                <Link to="/collection" className="relative group h-96 overflow-hidden premium-card cursor-pointer block">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="bg-primaryAction text-secondaryAction px-8 py-3 rounded-full font-bold tracking-widest uppercase text-sm shadow-[0_4px_14px_0_rgba(205,160,54,0.4)] transform translate-y-4 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 text-center">
                      {cat.name}
                    </span>
                  </div>
                </Link>
