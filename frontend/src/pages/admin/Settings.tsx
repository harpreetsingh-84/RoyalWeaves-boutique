  ...
  return (
    <div className="fade-in space-y-8 max-w-6xl mx-auto pb-20">
      ...
      <form onSubmit={handleUpdateContent} className="space-y-10">
        ...
        {/* UPI Config Section */}
        <section className="bg-[#03233c] rounded-xl shadow-sm border border-secondaryAction/20 overflow-hidden">
           <div className="bg-darkBg border-b border-secondaryAction/20 p-6 flex items-center gap-3">
           ...
           <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <input 
                  type="text" 
                  className="w-full text-sm bg-darkBg/50 text-lightText border border-secondaryAction/20 p-3 rounded-lg focus:ring-2 focus:ring-secondaryAction/30 outline-none font-mono" 
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                   <input 
                     type="text" 
                     className="flex-1 text-sm bg-darkBg/50 text-lightText border border-secondaryAction/20 p-3 rounded-lg focus:ring-2 outline-none w-full" 
                ...
                {siteContent.upiQrCode && (
                  <div className="mt-3 p-2 bg-darkBg inline-block border border-secondaryAction/20 rounded-lg">
                    <img src={siteContent.upiQrCode} alt="QR Code" className="h-24 object-contain brightness-90" />
                  </div>
                )}
              </div>
           </div>
        ...
        <section className="bg-[#03233c] rounded-xl shadow-sm border border-secondaryAction/20 overflow-hidden">
           ...
           <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <input 
                  type="email" 
                  className="w-full text-sm bg-darkBg/50 text-lightText border border-secondaryAction/20 p-3 rounded-lg focus:ring-2 focus:ring-secondaryAction/30 outline-none" 
              ...
              <div>
                ...
                <textarea 
                  rows={3}
                  className="w-full text-sm bg-darkBg/50 text-lightText border border-secondaryAction/20 p-3 rounded-lg focus:ring-2 focus:ring-secondaryAction/30 outline-none resize-none" 
        ...
        {/* Hero Slides Section */}
        <section className="bg-[#03233c] rounded-xl shadow-sm border border-secondaryAction/20 overflow-hidden">
           <div className="bg-darkBg border-b border-secondaryAction/20 p-6 flex items-center justify-between">
           ...
           <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
              {siteContent.heroSlides?.map((slide: any, idx: number) => (
                <div key={idx} className="bg-darkBg/50 border border-secondaryAction/20 rounded-lg p-5 space-y-4 relative">
                   ...
                   {slide.image ? (
                      <div className="w-full h-32 bg-darkBg rounded-md overflow-hidden mb-2 border border-secondaryAction/20">
                         <img src={slide.image} className="w-full h-full object-cover" alt={`Slide ${idx + 1}`} />
                      </div>
                   ) : (
                      <div className="w-full h-32 bg-darkBg rounded-md mb-2 flex flex-col items-center justify-center text-lightText/40 text-xs border border-dashed border-secondaryAction/20">
                         No Image Added
                      </div>
                   )}
                   ...
                   <div>
                     ...
                     <div className="flex flex-col sm:flex-row gap-2">
                        <input required type="text" className="flex-1 text-sm bg-transparent border border-secondaryAction/20 p-2 rounded outline-none text-lightText w-full focus:border-secondaryAction/60" value={slide.image} onChange={(e) => updateArrayItem('heroSlides', idx, 'image', e.target.value)} />
                   ...
                   <div>
                     ...
                     <input required type="text" className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded outline-none text-lightText focus:border-secondaryAction/60" value={slide.subtitle} onChange={(e) => updateArrayItem('heroSlides', idx, 'subtitle', e.target.value)} />
                   </div>

                   <div>
                     <label className="block text-[10px] font-bold text-lightText/60 uppercase tracking-wide mb-1">Main Headline</label>
                     <input required type="text" className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded font-bold text-lightText outline-none block focus:border-secondaryAction/60" value={slide.title} onChange={(e) => updateArrayItem('heroSlides', idx, 'title', e.target.value)} />
                   </div>

                   <div>
                     <label className="block text-[10px] font-bold text-lightText/60 uppercase tracking-wide mb-1">Description Paragraph</label>
                     <textarea required rows={2} className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded outline-none text-lightText resize-none focus:border-secondaryAction/60" value={slide.description} onChange={(e) => updateArrayItem('heroSlides', idx, 'description', e.target.value)} />
                   </div>
                </div>
              ))}
              ...
              <div 
                ...
                className="bg-darkBg/30 border-2 border-dashed border-secondaryAction/20 rounded-lg flex flex-col items-center justify-center text-lightText/40 hover:text-secondaryAction hover:border-secondaryAction/50 transition-colors cursor-pointer min-h-[300px]"
              >
        ...
        <section className="bg-[#03233c] rounded-xl shadow-sm border border-secondaryAction/20 overflow-hidden">
           ...
           <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
              {siteContent.features?.map((feat: any, idx: number) => (
                <div key={idx} className="bg-darkBg/50 border border-secondaryAction/20 rounded-lg p-5 space-y-4">
                   <div className="flex justify-between items-center mb-2">
                   ...
                   <div>
                     ...
                     <input required type="text" className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded text-lightText outline-none focus:border-secondaryAction/60" value={feat.title} onChange={(e) => updateArrayItem('features', idx, 'title', e.target.value)} />
                   </div>
                   
                   <div>
                     <label className="block text-[10px] font-bold text-lightText/60 uppercase tracking-wide mb-1">Icon Name (Lucide)</label>
                     <input required type="text" className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded text-lightText outline-none focus:border-secondaryAction/60" value={feat.icon} onChange={(e) => updateArrayItem('features', idx, 'icon', e.target.value)} placeholder="e.g. Sparkles, ShieldCheck, Truck, Clock" />
                   </div>
                   
                   <div>
                     <label className="block text-[10px] font-bold text-lightText/60 uppercase tracking-wide mb-1">Description</label>
                     <textarea required rows={3} className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded text-lightText outline-none resize-none focus:border-secondaryAction/60" value={feat.description} onChange={(e) => updateArrayItem('features', idx, 'description', e.target.value)} />
                   </div>
                </div>
              ))}
              ...
              <div 
                ...
                className="bg-darkBg/30 border-2 border-dashed border-secondaryAction/20 rounded-lg flex flex-col items-center justify-center text-lightText/40 hover:text-secondaryAction hover:border-secondaryAction/50 transition-colors cursor-pointer min-h-[250px]"
              >
                <Plus size={32} className="mb-2" />
                ...
                <div key={idx} className="bg-darkBg/50 border border-secondaryAction/20 rounded-lg p-5 space-y-4">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                     <div>
                       ...
                       <input required type="text" className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded text-lightText outline-none focus:border-secondaryAction/60" value={step.num} onChange={(e) => updateArrayItem('howItWorks', idx, 'num', e.target.value)} placeholder="01" />
                     </div>
                     <div>
                       <label className="block text-[10px] font-bold text-lightText/60 uppercase tracking-wide mb-1">Title</label>
                       <input required type="text" className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded text-lightText outline-none focus:border-secondaryAction/60" value={step.title} onChange={(e) => updateArrayItem('howItWorks', idx, 'title', e.target.value)} />
                     </div>
                   </div>
                   ...
                   <div>
                     <label className="block text-[10px] font-bold text-lightText/60 uppercase tracking-wide mb-1">Image URL / Upload</label>
                     <div className="flex flex-col sm:flex-row gap-2">
                        <input required type="text" className="flex-1 text-sm bg-transparent border border-secondaryAction/20 p-2 rounded outline-none text-lightText w-full focus:border-secondaryAction/60" value={step.image} onChange={(e) => updateArrayItem('howItWorks', idx, 'image', e.target.value)} />
                   ...
                   <div>
                     <label className="block text-[10px] font-bold text-lightText/60 uppercase tracking-wide mb-1">Description</label>
                     <textarea required rows={2} className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded outline-none text-lightText resize-none focus:border-secondaryAction/60" value={step.desc} onChange={(e) => updateArrayItem('howItWorks', idx, 'desc', e.target.value)} />
                   </div>
                </div>
              ))}
                ...
                <div key={idx} className="bg-darkBg/50 border border-secondaryAction/20 rounded-lg p-5 space-y-4">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                     <div>
                       ...
                       <input required type="text" className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded text-lightText outline-none focus:border-secondaryAction/60" value={review.name} onChange={(e) => updateArrayItem('testimonials', idx, 'name', e.target.value)} />
                     </div>
                     <div>
                       <label className="block text-[10px] font-bold text-lightText/60 uppercase tracking-wide mb-1">Role / Subtitle</label>
                       <input required type="text" className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded text-lightText outline-none focus:border-secondaryAction/60" value={review.role} onChange={(e) => updateArrayItem('testimonials', idx, 'role', e.target.value)} placeholder="Verified Buyer" />
                     </div>
                   </div>

                   <div>
                     <label className="block text-[10px] font-bold text-lightText/60 uppercase tracking-wide mb-1">Star Rating (1-5)</label>
                     <input required type="number" min="1" max="5" className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded text-lightText outline-none focus:border-secondaryAction/60" value={review.rating} onChange={(e) => updateArrayItem('testimonials', idx, 'rating', Number(e.target.value))} />
                   </div>
                   
                   <div>
                     <label className="block text-[10px] font-bold text-lightText/60 uppercase tracking-wide mb-1">Review Content</label>
                     <textarea required rows={4} className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded outline-none text-lightText resize-none focus:border-secondaryAction/60" value={review.content} onChange={(e) => updateArrayItem('testimonials', idx, 'content', e.target.value)} />
                   </div>
                </div>
              ))}
           ...
           <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
              {siteContent.featuredCategories?.map((cat: any, idx: number) => (
                <div key={idx} className="bg-darkBg/50 border border-secondaryAction/20 rounded-lg p-5 space-y-4">
                   ...
                   {cat.image && (
                      <div className="w-full h-40 bg-darkBg rounded-md overflow-hidden mb-2 border border-secondaryAction/20">
                   ...
                   <div>
                     ...
                     <input required type="text" className="w-full text-sm bg-transparent border border-secondaryAction/20 p-2 rounded text-lightText outline-none focus:border-secondaryAction/60" value={cat.name} onChange={(e) => updateArrayItem('featuredCategories', idx, 'name', e.target.value)} />
                   </div>
                   <div>
                     <label className="block text-[10px] font-bold text-lightText/60 uppercase tracking-wide mb-1">Spotlight Image</label>
                     <div className="flex flex-col sm:flex-row gap-2">
                        <input required type="text" className="flex-1 text-sm bg-transparent border border-secondaryAction/20 p-2 rounded outline-none text-lightText w-full focus:border-secondaryAction/60" value={cat.image} onChange={(e) => updateArrayItem('featuredCategories', idx, 'image', e.target.value)} />
        ...
        <div className="flex justify-end bg-darkBg/50 p-4 rounded-xl border border-secondaryAction/20 mt-8">
           <button 
             type="submit" 
