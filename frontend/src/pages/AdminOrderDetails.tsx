...
export default function AdminOrderDetails() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8 shadow-sm">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                 ...
                 <div className="bg-[#1a1a1a] p-4 rounded border border-blue-100 mb-4 space-y-2">
                    ...
                    <div className="flex flex-col text-sm border-t border-blue-50 pt-2">
                       ...
                       <span className="font-mono text-lg font-bold select-all bg-[#2a2a2a] p-2 rounded tracking-wider">{order.transactionId || 'NOT PROVIDED'}</span>
                    </div>
                 </div>
              ...
              <div className="flex flex-col items-center justify-center border-2 border-dashed border-blue-200 rounded-xl bg-[#1a1a1a] p-2">
      ...
      {/* Admin Controls Box */}
      <div className="bg-[#222] border border-[#444] rounded-xl p-6 mb-8 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-end">
          <div className="flex-grow w-full">
            ...
            <select 
              ...
              className="w-full bg-[#1a1a1a] border border-[#555] text-gray-100 text-sm rounded-lg focus:ring-accent focus:border-accent block p-2.5 capitalize"
            >
        ...
        <div className="relative opacity-70">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row justify-between gap-6 sm:gap-0">
            {steps.map((step, index) => {
              ...
              return (
                <div key={step} className="flex sm:flex-col items-center gap-4 sm:gap-2 relative bg-[#1a1a1a] sm:bg-transparent">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 transition-colors duration-300 ${isCompleted ? 'bg-green-500 border-green-500 text-white' : 'bg-[#1a1a1a] border-[#555] text-gray-400'}`}>
                    {isCompleted ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="bg-[#222] p-6 rounded-xl border">
          ...
          <div className="bg-[#222] p-6 rounded-xl border">
            ...
            <div className="text-gray-300 text-sm space-y-2">
              ...
              <p className="flex flex-col gap-1 border-t border-[#444] pt-2 mt-2">
                <span className="text-gray-400 text-[10px] font-bold uppercase tracking-widest">Transaction / UTR ID</span>
                <span className="font-mono bg-[#1a1a1a] px-2 py-1 border border-[#444] rounded select-all break-all">{order.transactionId || 'NOT PROVIDED'}</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-2">
          <div className="bg-[#1a1a1a] border rounded-xl overflow-hidden shadow-sm">
            <div className="py-4 px-6 border-b bg-[#222] flex justify-between items-center">
              <h3 className="text-lg font-semibold">Ordered Products</h3>
              <span className="text-sm font-medium bg-[#333] px-2 py-0.5 rounded-full">{order.items?.length || 0} Items</span>
            </div>
            <div className="divide-y">
              {order.items?.map((item: any, idx: number) => (
                <div key={idx} className="p-6 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                  <div className="w-20 h-20 bg-[#2a2a2a] rounded-lg overflow-hidden flex-shrink-0 border">
                    {item.product?.image || item.image ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center text-gray-400 bg-[#222]">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-2 text-sm text-gray-300 flex items-center gap-4 bg-[#222] inline-flex px-3 py-1 rounded-full border">
            ...
            <div className="p-6 bg-[#222] border-t">
              <div className="space-y-3 ms-auto max-w-sm w-full">
                ...
                <div className="border-t border-[#444] pt-3 mt-3 flex justify-between font-black text-xl text-gray-100">
